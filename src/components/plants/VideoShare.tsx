...
export const VideoShare = ({ plantName, videoTitle }: VideoShareProps) => {
  const shareUrl = window.location.href;
  const shareText = `Learn about ${plantName} - ${videoTitle} from the Virtual AYUSH Garden`;
  ...
  const shareViaEmail = () => {
    const subject = encodeURIComponent(`${plantName} - ${videoTitle}`);
